...
extension FlowController {
    ...
    func finish(from flowPresentation: FlowControllerPresentation,
                customDismiss: ((_ mainViewController: UIViewController) -> Void)? = nil, completion: (() -> Void)? = nil) {
        switch flowPresentation {
        case .present:
    ...
    fileprivate func finishPushed(completion: (() -> Void)?) {
        ...
        parentNavigationController.popViewController(animated: (completion != nil))
    }
}
